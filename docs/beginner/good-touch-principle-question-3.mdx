...
import GoodTouchPrincipleQuestion3 from "./good-touch-principle-question-3.yml";
...
- Alice has a clued 2 in her hand of an unknown color. (It was _2 Saved_ earlier on in the game, possibly either by Bob or before Bob drew the yellow 2)
